...
public class VinylProduct extends Product {
    ...
    public VinylProduct(int productQuantity, float price, String productCode, String description, List<VinylRecord> vinylRecords, int vinylRecordsQuantity) {
    ...
    public String toString() {
        return "VinylProduct{" +
                ...
                ", vinylRecordsQuantity=" + vinylRecordsQuantity +
                '}';
    }
