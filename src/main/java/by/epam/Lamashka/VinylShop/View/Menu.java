...
//        int choice = -1;
//        while (choice != 0 && response!="LogIn passed successfully" /*&& response!="Registration passed successfully"*/) {
//            try {
//                printMenu();
//                choice = in.nextInt();
//                switch (choice) {
...
//                        System.out.println(response=controller.executeCommand(CommandName.LOGIN, commandParameters));
//
//                        break;
//                    case 2:
//                        commandParameters=userDataInput();
//                        System.out.println(response=controller.executeCommand(CommandName.REGISTER, commandParameters));
//                        break;
//                    case 3:
//                        commandParameters=userDataInput();
//                        System.out.println(response=controller.executeCommand(CommandName.PASSWORD_CHANGE, commandParameters));
//
//
//                        break;
//                    case 0:
